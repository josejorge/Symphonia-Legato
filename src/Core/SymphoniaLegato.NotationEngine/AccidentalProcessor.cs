// File: AccidentalProcessor.cs
// Description: Determines which notes need a visible accidental, given the key signature and preceding accidentals in the measure.
