// File: ScoreCanvas.cs
// Description: The Avalonia control that paints a LayoutResult directly via DrawingContext — noteheads, stems, beams, staff lines, dynamics, slurs, lyrics, hand coloring, and note selection.
